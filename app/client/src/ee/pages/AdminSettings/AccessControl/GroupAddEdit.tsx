...
export function GroupAddEdit(props: GroupEditProps) {
  ...
  const isSavingName = useSelector(getAclIsSavingName);
          ...
          >
            <MenuTrigger>
              <Button
                ...
                data-testid="t--actions-cell-menu-icon"
                isIconButton
                kind="tertiary"
          ...
          {users && users.length > 0 ? (
            ...
            <NoUsersWrapper>
              ...
              <StyledButton
                ...
                isDisabled={!canAddUsersToGroup || isSavingName}
  ...
  return (
    <div className="scrollable-wrapper" data-testid="t--user-edit-wrapper">
      ...
      <PageHeader
        ...
        disableButton={!canAddUsersToGroup || isSavingName}
